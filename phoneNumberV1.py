...
def compare_excel(old_xlsx, new_xlsx, column_name):
    ...
    df_old = pd.read_excel(old_xlsx, engine='openpyxl')
    df_new = pd.read_excel(new_xlsx, engine='openpyxl')
...
old_xlsx = "대한광통신 사내전화번호부_20220110.xls";
new_xlsx = "대한광통신 사내전화번호부_20220211.xls";
column_name = '안산';


compare_excel(old_xlsx, new_xlsx, column_name);